...
2. Update Glitch project (https://chestnut-punishment.glitch.me/) with latest on GitHub. Do this by import from GitHub which wipes out the current project and repalces with new one.
